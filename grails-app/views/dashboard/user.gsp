...
<body>
    ...
    <div class="col-md-4 col-xs-12 col-sm-12 col-lg-4">
        <div class="row m-b-20">
            <g:render template="/expense/widgets/amountInAsset/index" model="[amountInAsset: dashboard.amountInAsset()]"/>
            <g:render template="/expense/widgets/amountInDebt/index" model="[amountInDebt: dashboard.amountInDebt()]"/>
        </div>
