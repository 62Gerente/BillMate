    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="simple-options-form-newRegularExpense">
                    ...
                    <div class="row form-row m-b-10">
                        <div class="col-md-12">
                            <input type="hidden" value="${user}"/>
                            <input type="hidden" class="custom-multiselect-newRegularExpense-circle" placeholder="<g:message code="com.billmate.expense.modal.placeholderCircle" default="Circle"/>" style="width:100%" class="select2-offscreen"/>
                        </div>
                    </div>
                    <div class="row form-row m-b-10">
                        <div class="col-md-6">
                            <input type="hidden" class="custom-multiselect-newRegularExpense-debt" placeholder="<g:message code="com.billmate.expense.modal.placeholderExpenseType" default="Expense Type"/>" style="width:100%" class="select2-offscreen"/>
                        </div>
                        <div class="col-md-6">
            ...
            <div class="modal-footer">
                <div class="pull-left">
                    <button type="button" class="btn btn-default btn-options-form-newRegularExpense"><g:message code="com.billmate.expense.modal.advancedOptions" default="Advanced options"/></button>
                </div>
