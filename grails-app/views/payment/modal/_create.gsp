<div class="modal fade" id="detailedMakePayments" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 id="myModalLabel" class="semi-bold"><g:message code="com.billmate.payment.make.mTitle" default="Pay Expense"/></h4>
                <p class="no-margin"><g:message code="com.billmate.payment.info" default="Fill in fields with information of the expense"/></p>
                <br>
            </div>
            <div class="modal-body">
                <div class="simple-options-form-detailedMakePayments">
                    <div class="row form-row m-b-10">
                        <div class="col-md-12">
                            <div class="input-group transparent">
                                ...
                                <input id="valueExpense" class="form-control value-detailedMakePayments" type="number" step="any" name="detailedMakePayments" value="" placeholder="<g:message code='com.billmate.payment.value' default='Value'/>"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="notification-messages no-padding m-t-20">
                    <div class="grid simple">
                        <div class="grid-body no-border">
                            <table class="table table-hover table-condensed" id="users-detailedMakePayments">
                                <thead>
                                <tr>
            ...
            <div class="modal-footer">
                <div class="pull-right">
                    ...
                    <button type="button" class="btn btn-primary btn-submit-new-detailedMakePayments">
