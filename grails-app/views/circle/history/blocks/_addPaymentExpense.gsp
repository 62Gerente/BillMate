...
<div class="cbp_tmlabel">
    <div class="p-t-5 p-l-30 p-r-20 p-b-10 xs-p-r-10 xs-p-l-10 xs-p-t-5">
        ...
        <h4 class="dark-text">
            <g:message code="com.billmate.action.addPaymentExpense.long" args="[action.getActor(), action.getExpense().getResponsible(), null, action.getExpense(), null, action.getPayment()]"/>
        </h4>
    </div>
