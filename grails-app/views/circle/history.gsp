...
<form id="history-filter-form" action="${createLink(action: 'history', params: [id: history.getCircle().getId()])}" method="POST">
    ...
    <div class="row">
        ...
        <div class="col-md-8 col-sm-offset-2 col-sm-offset-4">
            ...
            <div class="col-sm-5">
                <select name="user" class="history-select pull-right" style="width: 100%">
                    <option selected><g:message code="com.billmate.circle.user.all" default="All members"></g:message></option>
                    <g:render template="/user/selectGroup" model="[users: history.getRegisteredUsers()]"/>
                </select>
            </div>
    ...
    <div class="col-md-10 col-vlg-7">
        <g:render template="/circle/history/index" model="[circle: history.getCircle(), actions: history.getRealizedActions()]"/>
    </div>
