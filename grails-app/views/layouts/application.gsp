...
<body>
    ...
    <div class="page-container row-fluid">
      <g:render template="/house/modal/index" model="[users: user.getFriendsOfAllCircles(user.getId()), expenseTypes: user.getExpenseTypeByHouse(), path: user.getPathToDefaultPhoto(), user: user.getUser().getId()]"/>
