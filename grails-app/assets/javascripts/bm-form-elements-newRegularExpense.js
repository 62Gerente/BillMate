$(document).ready(function() {
    ...
    $(".btn-submit-new-newRegularExpense").click(function(){
        ...
        var receptionBeginDate = parent.find("div.row:nth(1) input.form-control").val();
        ...
        var formData = {name: name, idCircle: idCircleRegularExpense, idExpenseType: idExpenseTypeExpense, value: value, description: description,
            ...
            receptionBeginDate: receptionBeginDate, paymentEndDate: paymentEndDate, format: "json"};
    ...
    function displayDatePicker() {
        $('.clockTimeRegularExpense').datepicker({
            format: "dd/mm/yyyy",
            startView: 1,
            autoclose: true,
            todayHighlight: true
    ...
    $('.clockTimeRegularExpense').datepicker(displayDatePicker()).on('show', function() {
        var modal = $('.clockTimeRegularExpense').closest('.modal');
